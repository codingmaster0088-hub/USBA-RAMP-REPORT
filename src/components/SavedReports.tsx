        ...
        <div className="space-y-2">
          {filteredReports.map((report) => {
            ...
            return (
              <div
                key={report.id}
                className="bg-slate-900 border border-slate-800 rounded-xl p-3 shadow-md space-y-2 hover:border-amber-500/40 transition-all"
              >
                {/* Single Compact Line: Flight No, Destination, Depart Time */}
                <div className="flex items-center justify-between gap-2 border-b border-slate-800/80 pb-2">
                  <div className="flex items-center gap-2 min-w-0">
                    <span className="font-mono font-black text-amber-300 text-sm tracking-wide">
                      {report.flight}
                    </span>
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-blue-950 text-blue-300 border border-blue-800/60 truncate">
                      {report.route || 'N/A'}
                    </span>
                ...
                {/* Officer Name, ID & Last Modified Time + Actions */}
                <div className="flex items-center justify-between gap-2 pt-0.5 text-xs">
                  <div className="min-w-0 flex items-center gap-1.5 font-mono text-[11px]">
                    <ShieldCheck className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                    <span className="text-slate-200 font-extrabold truncate">
                      {report.officerName || 'RAMP OFFICER'}
                    </span>
                    <span className="text-[10px] bg-amber-500/20 text-amber-300 px-1.5 py-0.2 rounded border border-amber-500/30 shrink-0">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <button
                      ...
                      className="p-1 rounded-lg bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/40 text-[10px] font-bold flex items-center gap-1 active:scale-95 transition-all"
                      title="Download JPG"
                    >
                    ...
                    <button
                      ...
                      className="p-1 rounded-lg bg-blue-950 hover:bg-blue-900 text-blue-300 border border-blue-800 text-[10px] font-bold flex items-center gap-1 active:scale-95 transition-all"
                      title="Edit Report"
                    >
                    ...
                    <button
                      ...
                      className="p-1 rounded-lg bg-red-950/60 hover:bg-red-900 text-red-300 border border-red-800/60 text-[10px] font-bold active:scale-95 transition-all"
                      title="Delete Report"
                    >
