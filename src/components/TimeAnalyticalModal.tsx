  ...
  const handleExportExcel = async () => {
    ...
    const csvContent =
      ...
      [
        ...
        `Application build by USBA-20088 | Station: ${station}`,
        '',
        headers.join(','),
        ...rows.map((e) => e.join(','))
      ].join('\n');
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <div style={{ width: '32px', height: '32px', borderRadius: '8px', backgroundColor: '#1e3a8a', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '15px' }}>
                      ⚡
                    </div>
                    <div>
                      <span style={{ color: '#38bdf8', fontSize: '13px', fontWeight: 'bold', letterSpacing: '0.5px', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
